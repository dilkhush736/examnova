...
router.get("/:id", requireAuth, requireProfessionalMode, asyncHandler(uploadController.getUpload));
router.post(
  "/",
  requireAuth,
...
router.delete("/:id", requireAuth, requireProfessionalMode, asyncHandler(uploadController.archiveUpload));
